...
async function main() {
    ...
    const contractName = process.argv[2] || "Voting";
    ...
    try {
        ...
        const deploymentFile = path.join(deploymentsDir, `${contractName}-${hre.network.name}.json`);
...
function updateEnvFile(contractAddress) {
    ...
    try {
        ...
        console.log(`🔗 Explorer Link: ${getExplorerLink(hre.network.name, contractAddress)}`);
    } catch (error) {
